...
public class TraderAccountController {
    ...
    @ApiOperation(value = "Create a trader and an account with a DTO.",
    ...
    @ApiOperation(value = "Deposit a fund.",
            notes = "Deposit a fund to the account that associates with the given trader ID. Deposit "
    ...
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    @PutMapping(path = "/deposit/traderId/{traderId}/amount/{fund}")
    ...
    @ApiOperation(value = "Withdraw a fund.",
            notes = "Withdraw a fund from the account that is associated with the given trader ID. "
                    + "Withdraw amount must be greater than 0.0 and less than account balance.")
    @ApiResponses(value = {@ApiResponse(code = 404, message = "TraderId is not found"),
            @ApiResponse(code = 400, message = "Unable to withdraw due to user input")})
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    @PutMapping(path = "/withdraw/traderId/{traderId}/amount/{fund}")
